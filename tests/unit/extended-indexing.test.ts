...
function makeRootWithCodeBlocks(opts: {
  ...
  if (opts.textWithTags) {
    children.push({
      ...
      children: [{
        ...
        position: { start: { line: opts.textWithTags.line, column: 1 }, end: { line: opts.textWithTags.line, column: opts.textWithTags.text.length + 1 } },
      }],
      position: { start: { line: opts.textWithTags.line, column: 1 }, end: { line: opts.textWithTags.line, column: opts.textWithTags.text.length + 1 } },
    });
  }
  ...
  if (opts.inlineCode) {
    children.push({
      ...
      children: [{
        ...
        position: { start: { line: opts.inlineCode.line, column: 1 }, end: { line: opts.inlineCode.line, column: opts.inlineCode.text.length + 6 } },
      }],
      position: { start: { line: opts.inlineCode.line, column: 1 }, end: { line: opts.inlineCode.line, column: opts.inlineCode.text.length + 6 } },
    });
  }
  ...
  if (opts.codeBlock) {
    children.push({
      ...
      position: { start: { line: opts.codeBlock.line, column: 1 }, end: { line: opts.codeBlock.line + opts.codeBlock.text.split('\n').length, column: 3 } },
    });
  }
      ...
      children: [
        {
          type: 'paragraph',
          children: [
            { type: 'text', value: 'hello world', position: { start: { line: 2, column: 1 }, end: { line: 2, column: 12 } } },
            { type: 'text', value: 'hello again', position: { start: { line: 2, column: 13 }, end: { line: 2, column: 24 } } },
          ],
...
describe('updateExtendedIndexForFile', () => {
  ...
  it('idempotence: update then remove produces same index as full rebuild without file', () => {
    ...
    const allFiles = [
      fileEntry('/vault/a.md'),
      fileEntry('/vault/b.md'),
      fileEntry('/vault/c.md'),
    ];
